...
#ifdef SYNC
	void*	mergePathSync(PNODE	r, keyType	k, QUERY&	tmp);
	void	delSync(QUERY&	tmp);								//delete the k from root
	void	delSetSync(keyType	k, keyType	v, QUERY&	tmp);
#endif
